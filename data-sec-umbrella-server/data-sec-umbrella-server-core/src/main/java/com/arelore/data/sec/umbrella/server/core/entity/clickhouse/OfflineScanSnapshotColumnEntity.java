...
/**
 * ClickHouse 表 {@code offline_scan_snapshot_column}（与 scripts/clickhouse 对齐，只读查询）。
 */
@Data
@TableName(value = "offline_scan_snapshot_column", autoResultMap = true)
public class OfflineScanSnapshotColumnEntity {
    ...
    @TableField(value = "samples", typeHandler = ClickHouseStringArrayTypeHandler.class)
    private List<String> samples;

    @TableField(value = "sensitive_samples", typeHandler = ClickHouseStringArrayTypeHandler.class)
