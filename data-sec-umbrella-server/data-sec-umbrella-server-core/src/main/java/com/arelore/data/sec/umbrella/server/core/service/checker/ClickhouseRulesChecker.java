 ...
 * Clickhouse规则检查器
 */
public class ClickhouseRulesChecker extends AbstractDatabaseRulesChecker {
    ...
    public DatabasePolicyTestRulesResponse checkRules(DatabasePolicyTestRulesRequest request) {
        ...
        for (int i = 0; i < classificationRules.size(); i++) {
            ...
            detail.setDetail(matched ? "Clickhouse规则命中" : "Clickhouse规则未命中");
        ...
        response.setAiDetail(aiPassed ? "Clickhouse AI规则验证通过" : "Clickhouse AI规则验证未通过");
